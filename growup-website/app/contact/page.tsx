          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition shadow-lg cursor-pointer whitespace-nowrap"
                >
                  Send Message
                </button>
              </form>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@growup.com</p>
                </div>
